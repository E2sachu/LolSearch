 ...
 */
class Lieux extends \Projet\LolSearchBundle\Entity\Lieux implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'adresse', 'site', 'horaire', 'numero', 'description');
        }
