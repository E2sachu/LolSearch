...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // lolsearch_fiche
        if (0 === strpos($pathinfo, '/fiche') && preg_match('#^/fiche/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'lolsearch_fiche')), array (  '_controller' => 'Projet\\LolSearchBundle\\Controller\\JoueurController::ficheAction',));
        }
